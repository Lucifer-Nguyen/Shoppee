...
function SearchProductRequest(productName, productType, shippingUnit, productStatus,
  ...
  this.productStatues = productStatus;
...
function CreatProductRequest(id, name, image, price, productStatus, shippingUnit, productType) {
  this.id = id;
  this.name = name;
  this.image = image;
  this.price = price;
...
async function getListProduct() {
  let request = new SearchProductRequest(productName, productType, shippingUnit, productStatus,
    minPrice, maxPrice, pageSize, pageNumber, sortBy, sortType)
...
function fillProductsToTable(productList) {
  ...
  for (var index = 0; index < productList.length; index++) {
    ...
    let productStatus = product.productStatus === "NEW" ? 'Mới' : 'Đã sử dụng';
    ...
    <div href="#" class="home-product-item">
      ...
      <div class="home-product-item__price">
        <span class="home-product-item__price-current">Tình trạng: `+ product.productStatus + `</span>
      </div>
      <div class="home-product-item__price">
...
function editProduct(productId, imageProduct, productName, price, shippingUnit, productStatus, productType) {
  console.log(productId, imageProduct, productName, price, shippingUnit, productStatus, productType)
...
function saveProduct() {
  ...
  // Tạo 1 request
  let request = new CreatProductRequest(productId, productName, imageProduct, priceProduct, productStatus,
    shippingUnitProduct, productType);
...
function resetFormProduct() {
  ...
  document.getElementById("productStatus").value = "NEW";
  document.getElementById("shippingUnitProduct").value = "EXPRESS";
  document.getElementById("productType").value = "PHONE";
}
